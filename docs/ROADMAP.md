...
T5 AI investigator + hallucination set  | §6–7 — hypotheses as data, containment accounting
T6 admissibility gate (8) + decision EV | §8–9 — write-off stopping rule
T7 counterparties + idempotent executor | §10, §12 — failure injection
T8 clustering + prevention engine       | §14–15
